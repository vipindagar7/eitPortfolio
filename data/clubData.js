export const clubsOverview = [
  {
    icon: "Trophy",
    society: "Yuva Kreeda Society",
    tagline: "Play with Passion",
    description: "Powerhouse of sports & fitness on campus...",
    subclubs: ["Annual Sports Meet", "Indoor Games", "Outdoor Tournaments"],
  ...
  {
    icon: "Heart",
    society: "Samvedna Society",
    tagline: "Serve with Heart",
    description: "Dedicated to social causes...",
    subclubs: ["Social Media & Photography Club", "Raso Vaisa", "Samatva"],

    color: "#16A34A", // darker green (better contrast)
    accent: "rgba(22, 163, 74, 0.10)",
    border: "rgba(22, 163, 74, 0.30)",
  },
  {
    icon: "Palette",
    society: "Kshitij Cultural Society",
    tagline: "Where Art Meets Rhythm",
    description: "Cultural heartbeat of the campus...",
    subclubs: ["Music", "Dance", "Fine Art"],

    color: "#9333EA", // purple (distinct identity)
    accent: "rgba(147, 51, 234, 0.10)",
    border: "rgba(147, 51, 234, 0.30)",
  },
  {
    icon: "Cpu",
    society: "Technovation Club",
    tagline: "Innovate to Inspire",
    description: "For innovators and tech enthusiasts...",
    subclubs: ["Robotics", "Technova", "Science"],
  ...
  },
  {
    ...
    description: "Debates, poetry, storytelling...",
    subclubs: ["Debates", "Poetry", "Open Mic"],
  ...
  {
    icon: "Cpu",
    society: "The Computer Club",
    tagline: "Digital Skills. Future Ready.",
    description: "Coding, workshops, emerging tech...",
    subclubs: ["Coding", "Workshops", "Tech Talks"],
  ...
  },
  {
    ...
    subclubs: ["Blood Camps", "Plantation", "Swachhta"],

    color: "#DC2626", // red (strong identity)
    accent: "rgba(220, 38, 38, 0.10)",
    border: "rgba(220, 38, 38, 0.30)",
  },
  {
    icon: "Camera",
    society: "Social Media & Photography",
    tagline: "Frame Every Moment",
    description: "Captures campus life...",
    subclubs: ["Event Coverage", "Content", "Walks"],
